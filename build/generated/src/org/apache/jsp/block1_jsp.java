...
public final class block1_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("                   ");
               ...
               // String sql1="select * from stdntdetail where RegNumber='"+RegNo+"'";
                ...
                String sql4="SELECT * FROM stdntdetail INNER JOIN blockdetails ON stdntdetail.RegNumber = blockdetails.RegNumber where blockdetails.Blocknumber=1";
      ...
      out.write("</td><td>0");
      out.print( rs.getInt("PhoneNumber") );
      out.write("</td><td>");

<%-- 
    Document   : block5
    Created on : Aug 31, 2018, 1:52:33 PM
    Author     : samwel
--%>
    ...
    <div class="container" style="background-color: #fefefe; margin: 5% auto 15% auto; border: 1px solid #888; width: 100%;">
    		...
    		<table style="width: 100%;">
               ...
               // String sql1="select * from stdntdetail where RegNumber='"+RegNo+"'";
                ...
                String sql4="SELECT * FROM stdntdetail INNER JOIN blockdetails ON stdntdetail.RegNumber = blockdetails.RegNumber where blockdetails.Blocknumber=5";
